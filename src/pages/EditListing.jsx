...
function EditListing() {
  ...
  useEffect(() => {
    if (listing && listing.userRef !== auth.currentUser.uid) {
      toast.error('You canot Edit that listing')
      navigate('/')
    }


  }, [listing, auth.currentUser, navigate])
  ...
  () => {
    ...
    return <div className="profile">
        ...
        <main>
            ...
            <p className="imagesInfo">The firs Image will be the cover (max 6).</p>
            <input
                type="file"
